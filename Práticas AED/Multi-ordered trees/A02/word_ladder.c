...
//   N.Mec. 107463  Name: Pedro Miguel Ribeiro Rei
//   N.Mec. 108536  Name: Cristiano Nicolau
//   N.Mec. 108615  Name: Tiago Cruz
//
...
static void list_connected_component(hash_table_t *hash_table,const char *word)
{
  ...
  int number_of_vertices = breadh_first_search(len_list, list, node, NULL);
